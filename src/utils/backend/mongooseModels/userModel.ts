...
const UserSchema: Schema<IUser> = new mongoose.Schema({
  ...
  user_username: {
    type: String,
    required: [true, "User must have a unique username & only contain: numbers, letters, underscores, hyphens"],
  ...
  user_avatar: {
    type: String,
    default: "https://fonts.googleapis.com/css2?family=Material+Symbols+Outlined:opsz,wght,FILL,GRAD@48,400,0,0"
  },
  user_personalNotes: {
    type: [
      {title: {
